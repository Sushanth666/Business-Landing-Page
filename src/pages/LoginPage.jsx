...
export const LoginPage = ({ onNavigate }) => {
  ...
  return (
    <div className="min-h-screen bg-[#FBFBFC] flex flex-col justify-between py-8 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-96 h-96 rounded-full bg-[#F5ECFB] -z-0 blur-3xl pointer-events-none"></div>
          ...
          {isSuccess ? (
            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full pl-11 pr-4 py-3.5 rounded-xl border border-slate-200 focus:outline-hidden focus:ring-2 focus:ring-[#FF4820]/20 focus:border-[#FF4820] text-sm text-slate-800 transition-all placeholder:text-slate-300"
                    />
                ...
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    <a
                      ...
                      className="text-xs font-semibold text-[#FF4820] hover:underline cursor-pointer"
                    >
                      Forgot password?
                    </a>
                  </div>
                  <div className="relative">
                    <input
                      ...
                      className="w-full pl-11 pr-11 py-3.5 rounded-xl border border-slate-200 focus:outline-hidden focus:ring-2 focus:ring-[#FF4820]/20 focus:border-[#FF4820] text-sm text-slate-800 transition-all placeholder:text-slate-300"
                    />
                ...
                <div className="flex items-center justify-between pt-1">
                  <label className="flex items-center gap-2 cursor-pointer select-none">
                    <input
                      ...
                      className="w-4 h-4 rounded-xs border-slate-300 text-[#FF4820] focus:ring-[#FF4820] accent-[#FF4820]"
                    />
                ...
                >
                  {isLoading ? 'Signing In...' : 'Sign In to Undefine'}
                </button>
      ...
      <footer className="max-w-md mx-auto w-full text-center text-[11px] text-slate-400 flex items-center justify-center gap-1.5 z-10">
        ...
        <span>Bank-grade 256-bit SSL encrypted & GDPR compliant</span>
      </footer>
